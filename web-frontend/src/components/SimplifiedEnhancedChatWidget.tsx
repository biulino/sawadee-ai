...
const EnhancedChatWidget: React.FC<EnhancedChatWidgetProps> = ({
  ...
  useEffect(() => {
    ...
    // Load chat history
    loadChatHistory();
  }, [guestName, roomNumber, sessionId]);
  ...
  const rateMessage = (messageId: string | undefined, rating: 'positive' | 'negative') => {
  ...
  return (
    <div className="fixed bottom-4 right-4 w-96 h-[600px] bg-white rounded-2xl shadow-2xl border z-50 flex flex-col overflow-hidden">
      {/* Header */}
      <div 
